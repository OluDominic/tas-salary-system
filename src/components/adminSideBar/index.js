...
import './index.scss'
import { faBirthdayCake, faHome, faSuitcase, faUser, faUserFriends } from '@fortawesome/free-solid-svg-icons'
        ...
        <div className="adminsidebar">
            ...
            <hr />
                <ul>
                    ...
                    <li>
                        <Link> <FontAwesomeIcon icon={faSuitcase} /> User Profile </Link>
                    </li>
                    <li>
